...
class MultiImageMixDataset:
    ...
    def __init__(self,
                 ...
                 data_root = None, ann_file = None, data_prefix = None, filter_cfg=None, backend_args = None) -> None:
    ...
    def __getitem__(self, idx):
        ...
        for (transform, transform_type) in zip(self.pipeline,
                ...
                for i in range(self.max_refetch):
                    ...
                    if None not in mix_results:
                        if transform_type == 'Mosaic':
                            ...
                            results['mosaic_img_scale'] = transform.img_scale
                            results['mosaic_center_ratio_range'] = transform.center_ratio_range
                            results['mosaic_pad_val'] = transform.pad_val
                            results['mosaic_prob'] = transform.prob
                                                        
                        elif transform_type == 'Mixup':
            ...
            if transform_type == 'FilterAnnotations' or transform_type == 'PackDetInputs':
                for i in range(self.max_refetch):
                    # To confirm the results passed the training pipeline
                    # of the wrapper is not None.
                    updated_results = transform(copy.deepcopy(results)) ##ORIG
