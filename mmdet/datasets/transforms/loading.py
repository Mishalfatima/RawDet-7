...
class LoadAnnotations(MMCV_LoadAnnotations):
    ...
    def _load_bboxes(self, results: dict) -> None:
        ...
        for instance in results.get('instances', []):
            ...
            xmin = (instance['bbox'][0]/results['width']) * results['ori_shape'][1]
            ymin = (instance['bbox'][1]/results['height']) * results['ori_shape'][0]
            xmax = (instance['bbox'][2]/results['width']) * results['ori_shape'][1]
            ymax = (instance['bbox'][3]/results['height']) * results['ori_shape'][0]
