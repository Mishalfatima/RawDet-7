...
class XMLDataset(BaseDetDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for img_id in img_ids:
            ...
            img_path = osp.join(self.data_root,self.img_subdir,f'{img_id}.jpg')


            raw_img_info = {}
            raw_img_info['img_id'] = img_id
            raw_img_info['file_name'] = img_path
            raw_img_info['xml_path'] = xml_path
            raw_img_info['sensor'] = data
            raw_img_info['mode'] = string
    ...
    def parse_data_info(self, img_info: dict) -> Union[dict, List[dict]]:
        ...
        data_info['anno_path'] = img_info['xml_path']
        data_info['sensor'] = img_info['sensor']
        data_info['mode'] = img_info['mode']
        ...
        if size is not None:
            ...
            img_bytes = get(data_info['img_path'], backend_args=self.backend_args)
