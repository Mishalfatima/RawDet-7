...
class CheckpointHook(Hook):
    ...
    def after_train_epoch(self, runner) -> None:
        ...
        self._save_checkpoint_latest(runner)
    ...
    def _save_checkpoint_latest(self, runner) -> None:
        ...
        self.latest_ckpt = self.file_backend.join_path(self.out_dir,
                                                     ckpt_filename)
        ...
        save_file = osp.join(runner.work_dir, 'latest_checkpoint')
        with open(save_file, 'w') as f:
            f.write(self.latest_ckpt + " " + str(runner.epoch))
